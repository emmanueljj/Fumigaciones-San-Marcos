...
<style>
    ...
    .input-dark { background-color: #0f1012; border: 1px solid #2d3035; color: #e0e0e0 !important; border-radius: 12px; padding: 0.75rem; transition: 0.3s; }
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="card-dark p-4 h-100 shadow-lg border-0">
                    <h5 class="mb-4 fw-light text-white"><i class="fa-solid fa-pen-to-square me-2 text-info"></i>Modificar Servicio</h5>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="fecha" class="form-control input-dark" required 
                               ...
                               min="{{ $mes->fecha_I }}" max="{{ $mes->fecha_f }}">
                    </div>
                        ...
                        <div class="file-glass-container">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <span class="d-block text-white small" id="namePerimetral" style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">
                                        {{ $servicio->controlPerimetral ? 'Reporte guardado' : 'Seleccionar archivo' }}
                                    </span>
                                    <span style="color: #6dacd6; font-size: 0.65rem; font-weight: 700; text-transform: uppercase;">Reemplazar Reporte</span>
                                </div>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="observacion" class="form-control input-dark" rows="4" placeholder="Escribe detalles relevantes...">{{ old('observacion', $servicio->observacion) }}</textarea>
                    </div>
                </div>
            </div>
                            ...
                            <div id="lista-productos" class="selection-list">
                                @foreach($servicio->productos as $producto)
                                    <div class="badge-item">
                                        <input type="hidden" name="productos[]" value="{{ $producto->id_pr }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="lista-tecnicos" class="selection-list">
                                @foreach($servicio->tecnicos as $tecnico)
                                    <div class="badge-item">
                                        <input type="hidden" name="tecnicos[]" value="{{ $tecnico->id_tec }}">
                    ...
                    <div class="mt-auto pt-5">
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="/servicios/{{ $id_mes }}" class="btn btn-link text-decoration-none p-0" style="color: rgba(224,224,224,0.4); font-size: 0.9rem;">
                                <i class="fa-solid fa-chevron-left me-1"></i> Cancelar edición
                            </a>
                            <button type="submit" class="btn px-5 py-3 shadow-sm" style="background-color: #1c2a35; color: #6dacd6; border: 1px solid #243b4a; border-radius: 15px; font-weight: 600;">
                                <i class="fa-solid fa-arrows-rotate me-2"></i> Actualizar Servicio
                            </button>
                        </div>
                    </div>
                </div>
