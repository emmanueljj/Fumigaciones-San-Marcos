...
<div class="container py-4">
    <div class="form-card-minimal p-4 mx-auto" style="max-width: 450px;">
        <div class="text-center mb-4">
            ...
            <h5 class="mt-2 text-light">Editar Producto</h5>
        </div>
        ...
        <form action="/upProducto/{{$prod_mod->id_pr}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control input-dark" id="nombre" name="nombre" value="{{$prod_mod->nombre}}">
            </div>

            <div class="row g-3 mb-3">
                <div class="col-6">
                    <label for="concentracion" class="form-label-dark">Concentración</label>
                    <input type="text" class="form-control input-dark" id="concentracion" name="concentracion" value="{{$prod_mod->concentracion}}">
                </div>
                <div class="col-6">
                    <label for="metodo" class="form-label-dark">Método</label>
                    <input type="text" class="form-control input-dark" id="metodo" name="metodo" value="{{$prod_mod->metodo}}">
                </div>
            </div>

            <div class="mb-4">
                <label for="plaga" class="form-label-dark">Plaga</label>
                <input type="text" class="form-control input-dark" id="plaga" name="plaga" value="{{$prod_mod->plaga}}">
            </div>
